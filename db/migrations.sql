...
CREATE TABLE profiles (id SERIAL PRIMARY KEY, account_id INT, user_name VARCHAR(255), avatar_path TEXT DEFAULT 'profile_img.png', location VARCHAR(255), pc BOOLEAN, ps4 BOOLEAN, xbo BOOLEAN, wiiu BOOLEAN, ps3 BOOLEAN, xb360 BOOLEAN, wii BOOLEAN, steam_id BIGSERIAL, psn_id VARCHAR(255), xbl_id VARCHAR(255));
